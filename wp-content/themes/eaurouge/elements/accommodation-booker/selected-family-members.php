    ...
    <div class="family-member" id="family-member-you">
        <div class="input-field">
            ...
            <span class="input-with-icon">
                <i class="user"></i>
                <input name="your_name" id="your_name" class="family-member-name required" autocomplete="off" type="text" />
            </span>
        </div>
    </div>
        ...
        <div id="family-member-template">
            <div class="family-member">
                <div class="input-field">
                    ...
                    <span class="input-with-icon">
                        <i class="user"></i>
                        <input name="member_MEMBER_COUNT_name" id="member_MEMBER_COUNT_name" class="family-member-name required" autocomplete="off" type="text" />
                    </span>
                </div>
            </div>
        </div>
